...
course_config = CourseConfig(course_code = "ncodl",                  # The abbreviated version of the course (4 chars preferred)
                             course_name = "nco-data-lineage-with-uc",        # The full name of the course, hyphenated
                             data_source_name = "nco-data-lineage-with-uc",   # Should be the same as the course
...
lesson_config = LessonConfig(name = None,                           # The name of the course - used to cary state between notebooks
                             ...
                             installing_datasets = False,            # Indicates that the datasets should be installed or not
